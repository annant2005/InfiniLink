...
import { getAuth, GoogleAuthProvider, signInWithEmailAndPassword, signInWithEmailLink, signInWithPopup, signOut } from 'firebase/auth';
...
function SignIn() {
  ...
  return (
    <>
      ...
      <p>Try to voilate the guidelines an you will get a nightmare tomorrow!</p>
    </>
  )
}
